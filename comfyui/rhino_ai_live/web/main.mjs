...
async function report(state,detail={}) {
  const payload={schema:"rhino-ai-frontend/1",version:28,state,active:workflowName(activePath())||null,open:(workflows()?.openWorkflows||[]).map(w=>workflowName(w.path)),...detail};
